...
class AuthControllerTest {
    ...
    void kakaoLoginNewUserReturns200() throws Exception {
        // TODO: KakaoLoginResponse 구현 후 주석 해제
        ...
        //         .content(objectMapper.writeValueAsString(Map.of("kakaoAccessToken", "valid-kakao-token"))))
    ...
    void kakaoLoginInvalidTokenReturns401() throws Exception {
        // TODO: 구현 후 주석 해제
        // given(authService.kakaoLogin("bad-token")).willThrow(new InvalidKakaoTokenException());
        //
        // mockMvc.perform(post("/api/v1/auth/kakao")
        //         .contentType(MediaType.APPLICATION_JSON)
        //         .content(objectMapper.writeValueAsString(Map.of("kakaoAccessToken", "bad-token"))))
    ...
    void refreshTokenSuccessReturns200() throws Exception {
        // TODO: 구현 후 주석 해제
        // given(authService.refreshToken("valid-rt")).willReturn(new TokenRefreshResponse("new-at"));
        //
    ...
    void refreshTokenInvalidReturns401() throws Exception {
        // TODO: 구현 후 주석 해제
        // given(authService.refreshToken("bad-rt")).willThrow(new InvalidRefreshTokenException());
        //
        // mockMvc.perform(post("/api/v1/auth/refresh")
        //         .contentType(MediaType.APPLICATION_JSON)
