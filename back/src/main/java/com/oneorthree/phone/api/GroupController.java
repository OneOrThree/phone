...
public class GroupController {
    ...
    //  - 시그니처: deleteGroupChallenge(@PathVariable UUID groupId, @PathVariable UUID challengeId,
    //              HttpServletRequest httpServletRequest)
    //  - userId = (UUID) httpServletRequest.getAttribute("userId") 패턴 유지
    //    → groupService.deleteChallenge(groupId, challengeId, userId)
    //  - @Operation/@ApiResponses(204/403/404) 추가, import: org.springframework.web.bind.annotation.DeleteMapping
}
