 ...
 *
 * <p>이 기능을 처음 만난 시점부터 7일은 무제한(trial), 이후 롤링 7일 내 3회로 제한된다.
 *
 * @param unlimited trial(무제한) 구간이면 true. true 면 remaining·resetAt 은 null.
 * @param remaining 남은 생성 횟수(0~3). 무제한 구간이면 null.
