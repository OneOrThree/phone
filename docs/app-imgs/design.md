...
- `app/legacy/app-dev/src/assets/character_happy.png`
- `app/legacy/app-dev/src/assets/character_study.png`
- `app/legacy/app-dev/src/assets/tier_image/tier2.png` ~ `tier5.png`
