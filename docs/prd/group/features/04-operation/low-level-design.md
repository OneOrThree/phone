...
| E2E  | MEMBER 나가기, 다인 OWNER 위임 후 나가기, 마지막 1인 `ENDED`, 강퇴 후 old slug·미claim click·목록·방 접근 불가, 비활성 토글 제외, 2xx 뒤 최신 화면 수렴, 일반 4xx/5xx false success 0건, `NOT_FOUND | MEMBER_ONLY` postcondition 확인 뒤 멱등 종료 |
