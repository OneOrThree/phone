...
| `F02-T8`~`T9` 운영·접근성·계측 | [UX §7](./ux-design.md#7-그룹-설정) · [UX §11](./ux-design.md#11-접근성-정본) · [공통 분석 계약](../../shared/analytics.md) · [LLD §6~8](./low-level-design.md#6-첫-카드-덱-안내)                           |
...
- 앱·분석·QA: [`F02-T9`](./prd.md#12-작업-패키지와-후속-결정) 계측·접근성·E2E
