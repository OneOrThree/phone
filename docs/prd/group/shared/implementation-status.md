...
| --------------------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| 01 획득<br>`GRP-01`         | 🟡 일부 구현             | 공개 찾기, 직접·복원 초대, 생성·가입, 성공 뒤 전체 목록 재확인과 초대 대상 방 이동                              | 비공개 문구·legacy 전환, link 폐기/버전·claim·가입 강제, 검색 식별자, 시도 `result_track`, 생성 lock, F3 query                        | 백엔드·앱·분석·QA        | slug 앱 최소 버전·재발급·강제 시각, 폐기 뒤 claim no-op와 비공개 `inviteSlug` authorization·잠금 순서·경합 계약을 합의         | public legacy·active private 성공, legacy·무효·폐기·발급자 이탈 차단, link race·GA4/S-LOG·F3 fixture 통과                               |
