...
| --------------------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| 01 획득<br>`GRP-01`         | 🟡 일부 구현             | 공개 찾기, 직접·복원 초대, 생성·가입, 성공 뒤 전체 목록 재확인과 초대 대상 방 이동                              | 비공개 UI 문구, 구형 private 링크 전환, 서버 가입 강제, 검색 `appInstanceId`, 생성 이중 실행 잠금, F3 30분 episode query              | 백엔드·앱·분석·QA        | 과장 문구를 완화하고 slug 형식 앱 최소 버전·구형 링크 재발급·강제 시각과 비공개 `inviteSlug` API·오류 계약을 합의              | public legacy·유효 private 가입 성공, private legacy·무효 slug·직접 요청 차단, GA4/S-LOG와 F3 dedupe fixture 통과                       |
