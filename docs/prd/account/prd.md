...
| FR09 | notifications만 서버 동기화, 음량/음소거/진동/동작 줄이기는 기기 로컬 PATCH 응답은 요청값 복사가 아니라 정본 현재 값(SUPERSEDED면 적용 척 금지)이고 앱은 마지막 명령 응답만 반영. GET 누락 행 복구는 tombstone·세대 원자 대조 | 원본 설정 계약 |
