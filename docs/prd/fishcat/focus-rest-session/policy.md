...
산식은 GROMO-1830 으로 확정됐고, 보상 귀속(D5-귀속-개정)·강퇴 정책(FR-D03)·지급 시점과 하루 경계(D5-적립·FR-D03-기지급)까지 닫혀 GROMO-1763의 '보상 산식 확정' 완료 조건도 닫힌다. 남은 것은 개인 지갑 적립(개인 돈벌기) 방향뿐이다 — 집중 보상은 섬 통장 100% 다.
