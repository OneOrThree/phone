...
- 종료 결과의 earnedFish와 allocation은 서버가 확정한 값이다. 앱이 목업 비율로 계산해 지갑에 더하지 않는다. (allocation 의 배분은 2026-09-18 재영님 결정 D5-귀속으로 확정됐다 — 개인 지갑 50% + 섬 통장 50%, 비율은 운영값이라 설정으로 조정한다.)
