...
| 출시 정책 | FR-D01~06의 필요한 결정과 설정 검증. 산식은 1830 확정(60초당 1마리 — 2026-09-18 D5 승격)이며 설정 revision 으로 주입한다; 보상 귀속(FR-D01 보류)·강퇴(FR-D03 설명 대기) 확정 전 지급 경로를 켜지 않음. FR-D02 는 D6 로 폐기 — [결정 로그](../decision-log.md) |
