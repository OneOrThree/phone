...
- 종료 결과의 earnedFish와 allocation은 서버가 확정한 값이다. 앱이 목업 비율로 계산해 지갑에 더하지 않는다. (~~allocation~~ 은 폐기된 FR-D02 모델의 형태다 — 2026-09-18 D6. earnedFish 의 개인 지갑/섬 통장 귀속은 [정책](policy.md) FR-D01 보류 칸이 정해진 뒤 이 서술을 개정한다.)
