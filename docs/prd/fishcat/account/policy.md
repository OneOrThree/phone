...
2026-09-25 [RP-게스트쓰기](../character-report/policy.md#rp-게스트쓰기--게스트-커뮤니티-쓰기와-제재-승계)는 2.0 게스트의 친구 요청·편지 등 커뮤니티 쓰기를 유지한다. 쓰기 전 확인 이메일을 통한 제재·차단 승계는 후속 설계안이며 현행 1992 서버 가드에는 아직 반영되지 않았다. 상점 구매의 소셜 로그인 조건은 유지한다.
