...
미결 제품 정책(2026-09-18 갱신): 상품 가격(상점 S03), ~~집중 보상의 개인/섬 귀속(FR-D01 보류)~~ → 2026-09-18 D5-귀속으로 확정(개인 50% + 섬 통장 50%, 비율은 운영값)·집중/휴식 접근, 계정 재인증·삭제 보존, 퀘스트 대상주민·랭킹 분모/섬 귀속, 복수기기 측정 병합(RC-D02 보류). **2026-09-18 결정으로 빠진 것**: 기존 코인/보유품 승계(1909 A05·D11 — 승계·이관 안 함), 새 경제 운영값(1829·1830 확정), 건설 완료 전후 기여/잔량(D6 폐기), 공동소비 권한(D2), 초대 승인 생략(D10 — 승인제 유지). 정본은 [결정 로그](../decision-log.md). 이 설계로 정책 승인이나 운영 활성화가 이루어지지 않는다.
