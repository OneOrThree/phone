...
근거는 [기존 운영 HLD](../../gromo/group/features/04-operation/high-level-design.md), [기존 운영 LLD](../../gromo/group/features/04-operation/low-level-design.md), [획득 링크 수명](../../gromo/group/features/01-acquisition/high-level-design.md)다. 코드의 미구현/경합 한계는 본 문서의 LLD에서 별도로 밝힌다.
