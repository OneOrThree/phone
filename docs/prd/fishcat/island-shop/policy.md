...
|S03|**미결 — 판매 활성화를 막는다.** 가격·보상표를 운영값으로 채택할지. 테이블은 선구축(2026-09-19 SH-테이블, V74) — 가격 행 없음·`price` NULL = 구매 불가|원본 가격·보상 대부분 목업(건설비·집중/퀘스트 보상은 1829·1830 으로 확정됐고 **상품 가격만** 남았다)|approved/effective 설정 없으면 구매 비활성. 0원으로 간주하지 않음|
