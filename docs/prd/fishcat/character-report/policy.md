...
| 미종결 신고의 제재 귀속 표지 | 신고 접수 시 확인한 피신고자 제공자·주체의 keyed digest를 사건 ID에 최소 연결하고 탈퇴 전에 내구 확인한다. 심사 전 탈퇴·동일 제공자 재가입이 있어도 최종 판단을 새 계정에 승계한다. 위반 없음/검토 미완료 종결 시 파기하고, 위반 확정 시 활성 제재·누진 단계 표지로 전환한다. 법적 근거·최소 보존 기간을 출시 전 확인 | 탈퇴가 심사 중인 신고의 책임 주체를 지우지 않음 |
