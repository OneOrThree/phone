...
> |---|---|
> | 결정일 | 2026-08-08 |
> | 최종 갱신 | 2026-08-10 (**구현 대조 정정** — 구현과 갈린 자리를 정본에 맞춰 현행화: 사유 enum 이름(`INSUFFICIENT_PARTICIPANTS`·`REFUND_DEADLINE`), 에러코드 신설·개명 철회(`NOT_OWNER`·`BET_NOT_FOUND`·`BET_CLOSED`), 창 사용분 보고 게이트 2갈래화, seen 마커 값·프룬, §B6 사일런트 푸시 시점 = `settle_after` − 15분. **결정 로그 N1~N54 항목 자체는 그대로다**) |
...
| S12 | 회차에 `void_reason` 추가 + 종료 상태 `UNUSED` 신설 | N33 · N52 · **GROMO-1404** |
