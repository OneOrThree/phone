...
| 작업                                   | 추가로 읽을 정본                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `F02-T1`~`T2` 카드 골격·앞면           | [UX §2](./ux-design.md#2-캐러셀과-카드-골격) · [HLD §2·4](./high-level-design.md#2-화면-컴포넌트와-소유권) · [LLD §1·3](./low-level-design.md#1-그룹-카드의-정체성과-화면-복구) · 1·5·6·7·10·11개 이상과 끝 카드의 page/indicator 안정성                                                                                                                                                           |
...
| `F02-T8`~`T9` 운영·첫 안내·접근성·계측 | [UX §7](./ux-design.md#7--그룹-설정) · [UX §1.1](./ux-design.md#11-첫-카드-덱-코치마크) · [HLD §6](./high-level-design.md#6-그룹-카드-첫-노출-코치마크-계약) · [공통 분석 계약](../../shared/analytics.md#2-기능별-이벤트cohort-fact-사전) · [LLD §6](./low-level-design.md#6-첫-카드-덱-안내) · [§7](./low-level-design.md#7-카드-기능의-계측-상태) · [§8](./low-level-design.md#8-구현출시-검증) |
...
- 완료: 320·390·430·768pt × 그룹 1·5·6·7·10·11개 이상에서 page 수, dots/compact, active `groupId` 보존과 끝 `FindMoreCard` 비저장 단위 테스트가 통과한다.
...
- 앱: [`F02-T1`~`F02-T8`](./prd.md#12-작업-패키지와-후속-결정) 구현·회귀. `F02-T4`는 grip drag와 단일 포인터 popover를 같은 stable-ID 이동 reducer에 연결하고, 5·10·11개 이상 cross-page·focus/popover 유지 회귀를 포함한다. `F02-T6`는 CTA 수락마다 비식별 `interaction_id`를 route 결과까지 보존한다.
