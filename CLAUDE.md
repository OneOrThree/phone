...
- **Business API**: `satellite-ci.yml` — 독립 Gradle build(Checkstyle·SpotBugs·Redis 통합 테스트)와 Docker 빌드. main push에서만 GAR 이미지 게시. 수동 dev overlay는 `docker-compose.business.yml`.
