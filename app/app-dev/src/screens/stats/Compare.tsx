// ST1 비교 블록(총 집중시간 카드 하단) — 전 기간(일/주/월) 평균 집계 API 기반(ComparePeriod).
// 주 탭도 서버 평균으로 전환(GROMO-1632 — 리그 랭킹 기반 CompareWeek 폐지).
...
// ST1 비교(GROMO-833) — 3축(친구/전체/같은 카테고리) 모두 평균 집계 API(753)로 조회.
