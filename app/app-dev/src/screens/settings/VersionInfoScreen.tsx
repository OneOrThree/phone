...
const s = StyleSheet.create({
  ...
  appName: { ...T.text.title, color: T.ink, marginTop: T.space.xl },
  version: { ...T.text.body, color: T.inkSub, marginTop: T.space.sm },
  build: { ...T.text.caption, color: T.inkMuted, marginTop: T.space.xs },
  latestPill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: T.space.sm,
