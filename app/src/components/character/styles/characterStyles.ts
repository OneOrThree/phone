...
import { T } from '@/constants/theme'; // 앱 전체 색상 팔레트
...
export const s = StyleSheet.create({
  ...
  sweat: {
    ...
    borderTopRightRadius: 0, // 물방울 모양 만들기
  ...
  dbWeight: {
    ...
    height: 14,
    borderRadius: 7,
    backgroundColor: T.inkMed,
    borderWidth: 1.5,
    borderColor: INK, // 원판 색상: T.inkMed
  },
  dbBar: {
    width: 22,
    height: 6,
