...
export function ScreenTimeCelebrationModal({ visible, streakDays, onClose }: Props) {
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={s.overlay}>
        ...
        <View style={s.card}>
          ...
          <Text style={s.title}>어제 사용 시간 목표 달성! 🎉</Text>
          <Text style={s.sub}>오늘도 목표 이내로 유지해요!</Text>
