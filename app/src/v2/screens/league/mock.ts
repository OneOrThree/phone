...
export const RANKING: RankedMember[] = [
  ...
  // prettier-ignore
  { rank: 2, userId: 'u-02', nickname: '현생사는중', totalFocusMinutes: 2102, result: null, tierLevel: 5, exam: '변리사', achievedRate: 0.88, friendCount: 94, streakDays: 14, bestRank: 1, bestWeekMinutes: 2350 },
  // prettier-ignore
  { rank: 3, userId: 'u-03', nickname: '준비된자', totalFocusMinutes: 1907, result: null, tierLevel: 4, exam: '노무사', achievedRate: 0.84, friendCount: 61, streakDays: 9, bestRank: 2, bestWeekMinutes: 2100 },
  // prettier-ignore
  { rank: 4, userId: 'u-04', nickname: '합격기원', totalFocusMinutes: 1690, result: null, tierLevel: 4, exam: '공무원', achievedRate: 0.8, friendCount: 47, streakDays: 7, bestRank: 3, bestWeekMinutes: 1900 },
  // prettier-ignore
  { rank: 5, userId: 'u-05', nickname: '서연', totalFocusMinutes: 1498, result: null, tierLevel: 4, exam: '노무사', achievedRate: 0.76, friendCount: 33, streakDays: 5, bestRank: 4, bestWeekMinutes: 1720 },
  // prettier-ignore
  { rank: 6, userId: 'u-06', nickname: '태강', totalFocusMinutes: 1360, result: null, tierLevel: 3, exam: '변리사', achievedRate: 0.7, friendCount: 52, streakDays: 4, bestRank: 3, bestWeekMinutes: 1580 },
  // prettier-ignore
  { rank: 7, userId: MY_USER_ID, nickname: '진수', totalFocusMinutes: 1295, result: null, tierLevel: 3, exam: '노무사', achievedRate: 0.67, friendCount: 18, streakDays: 3, bestRank: 5, bestWeekMinutes: 1490 },
  // prettier-ignore
  { rank: 8, userId: 'u-08', nickname: '유진', totalFocusMinutes: 1212, result: null, tierLevel: 3, exam: '세무사', achievedRate: 0.64, friendCount: 25, streakDays: 2, bestRank: 6, bestWeekMinutes: 1400 },
  // prettier-ignore
  { rank: 9, userId: 'u-09', nickname: '도윤', totalFocusMinutes: 1050, result: null, tierLevel: 2, exam: '공무원', achievedRate: 0.55, friendCount: 12, streakDays: 1, bestRank: 7, bestWeekMinutes: 1210 },
  // prettier-ignore
