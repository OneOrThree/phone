  ...
  return (
    <SafeAreaView style={s.root} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        >
          <LinearGradient colors={['#EEF0FB', '#E1E4F5']} style={s.hero}>
...
const s = StyleSheet.create({
  ...
  tierRowCur: { backgroundColor: '#EEF0FB', borderWidth: 2, borderColor: '#5E6AD2' },
  tierNameCol: { flex: 1 },
  ...
  noticeStrong: { fontWeight: '700', color: '#667085' },
});
