...
import {
  ...
  SettingsRow,
  SettingsToggleRow,
} from '@/v2/screens/settings/components/SettingsList';
...
const s = StyleSheet.create({
  ...
  sheetTitle: { ...T.text.subtitle, color: T.ink, textAlign: 'center', marginBottom: 6 },
  pickerRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4, marginBottom: 18 },
  pickerCol: { flex: 1 },
  colon: { ...T.text.title, color: T.inkSub, marginHorizontal: 4 },
  confirmBtn: {
    height: 54,
    borderRadius: 16,
