...
const s = StyleSheet.create({
  ...
  gaugeCap: { ...T.text.caption, color: '#5B7A48' },
  gaugeVal: { ...T.text.display, fontSize: 34, color: T.ink, lineHeight: 38 },
  gaugeUnit: { fontSize: 16, fontWeight: '700', color: '#5B7A48' },
  goal: { ...T.text.title, fontSize: 30, color: T.ink, marginTop: 12 },
  ...
  cardRed: { backgroundColor: '#FBEFEC', borderColor: '#EFD9D2' },
  cardGreen: { backgroundColor: '#F2F6EE', borderColor: '#DEE9D3' },
  cardCap: { fontSize: 10, fontWeight: '500', color: T.inkMuted },
  cardVal: { fontSize: 19, fontWeight: '800', marginTop: 2 },
  arrow: { fontSize: 16, color: T.inkMuted },
});
