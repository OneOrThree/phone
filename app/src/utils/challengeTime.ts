...
export function timeStrToSeconds(timeStr: string | null | undefined): number {
...
export function nowSecondsInZone(
...
export function zoneSuffix(timeZone: string | null | undefined): string {
