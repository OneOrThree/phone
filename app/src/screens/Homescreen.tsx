...
interface ScreenTimeReportViewProps {
  reportContext?: string;
  goalSeconds?: number;
  style?: StyleProp<ViewStyle>;
}
const ScreenTimeReportView =
  ScreenTimeReportViewRaw as unknown as ComponentType<ScreenTimeReportViewProps>;
...
function StatBox({ label, value, valueComponent }: StatBoxProps) {
  return (
...
export default function HomeScreen({ navigation, route }: TabScreenProps<'홈'>) {
  ...
  const [authStatus, setAuthStatus] = useState<AuthorizationStatus | null>(null); // null = 확인 중
