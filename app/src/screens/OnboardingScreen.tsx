...
export default function OnboardingScreen({ onComplete }: OnboardingScreenProps) {
  ...
  const [wakeTime, setWakeTime] = useState<TimeValue>({ hour: 0, minute: 0 });
  const [sleepTime, setSleepTime] = useState<TimeValue>({ hour: 0, minute: 0 });
  const [reportTime, setReportTime] = useState<TimeValue>({ hour: 0, minute: 0 });
