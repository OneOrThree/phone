...
//
// 그룹방 본체는 라우트가 아니라 컴포넌트다. A-9 이후 GroupScreen은 소속 수와 무관하게 목록이
// 기본이고, 목록에서 그룹을 고르면 이 래퍼를 통해 push 된다(1건 내장 렌더는 폐지).
...
const s = StyleSheet.create({
  // 배경은 목록(GroupScreen)과 같은 흰 캔버스 — 진입 경로가 달라도 같은 톤을 유지한다.
