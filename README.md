...
| 바로 시작하기 | 문서 |
| --- | --- |
| 앱을 실행하고 싶어요 | [앱 시작하기](app/legacy/app-dev/README.md#로컬-실행) |
...
| 경로 | 역할 | 상세 문서 |
| --- | --- | --- |
| `app/legacy/app-dev/` | **동결된 1.x 앱**(스토어 1.1.0까지) — React Native·Expo 앱, iOS 확장, Android 네이티브 프로젝트. 2.0.0 부터는 같이숲 v2 앱이 `app/app-dev/`에 들어옵니다 | [앱 README](app/legacy/app-dev/README.md) |
...
네이티브 빌드, 백엔드 연결, TestFlight·Android 배포는 [앱 README](app/legacy/app-dev/README.md)를 참고합니다.
...
| 앱 구조·실행·배포 | [app/legacy/app-dev/README.md](app/legacy/app-dev/README.md) |
