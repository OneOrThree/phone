 ...
 *
 * <p>관문이 하나여야 하는 이유는 입구가 넷이기 때문이다 — STOMP CONNECT · SUBSCRIBE · SEND,
...
public class ChatAccessGuard {
    ...
    /**
     * 섬을 특정하지 않는 입구(방 목록 조회, STOMP CONNECT)용 — 집중 여부만 본다.
     *
     * <p>CONNECT 에서 이미 막는 것이 중요하다. 구독·발신에서만 막으면 집중 중에도 소켓은 열려 있어,
     * 앱이 「연결됨」으로 보이는 상태에서 아무것도 못 하는 어정쩡한 화면이 된다.
     */
