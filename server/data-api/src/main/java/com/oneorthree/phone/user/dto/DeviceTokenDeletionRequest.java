 ...
 *
 * @param deviceToken    대상 FCM 토큰({@code X-Device-Token}). 없으면 소유권 또는 세션으로 한정한다
...
public record DeviceTokenDeletionRequest(
        ...
        Long authGeneration,
        UUID sessionId) {
    public DeviceTokenDeletionRequest(String deviceToken, String ownershipToken, Long authGeneration) {
        this(deviceToken, ownershipToken, authGeneration, null);
    }
}
