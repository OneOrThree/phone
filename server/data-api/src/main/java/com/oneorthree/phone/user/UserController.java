 ...
 * {@code /me/settings} 로 옮겨 가 지웠고(GROMO-1947, A24④), 기기 토큰 2종도 business-api 이관으로
 * 지웠다(GROMO-2070). 남은 것은 2.0 매핑이 결정되지 않은 닉네임 사전확인·직업 저장이다
 * (legacy-v1-retirement §5). Swagger 애노테이션은 {@link UserControllerDocs} 로 분리했다(GROMO-1621).
 */
@RestController
