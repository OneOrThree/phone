...
/**
 * 편지 도메인의 업무 규칙 위반. 언체크 예외라 서비스가 그대로 던지면 트랜잭션이 롤백되고,
 * 공통 핸들러가 {@link LetterErrorCode} 의 상태·문구로 응답을 만든다({@code FriendException} 과 같은 모양).
 */
public class LetterException extends DomainException {
     ...
     */
    public LetterErrorCode getErrorCode() {
        return errorCode;
    }
}
