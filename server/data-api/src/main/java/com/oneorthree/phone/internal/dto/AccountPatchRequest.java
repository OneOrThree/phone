...
/**
 * 공개 {@code PATCH /me} 의 내부 본문 (GROMO-1801·1945). Business 가 공개 본문을 검증한 뒤 온 필드만 싣는다 —
 * 카탈로그 밖 {@code catColor} 는 Business 가 422 로 끝내므로 여기 오면 계약 위반이라 400 이다. 두 필드 중 하나
 ...
 */
public record AccountPatchRequest(String name, String catColor) {

    private static final Set<String> FIELDS = Set.of("name", "catColor");
